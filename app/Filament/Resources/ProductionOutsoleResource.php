        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('production_date')
                    ->state(fn ($record) => $record->outsoleSizeruns->first()->started_work_time)
                    ->date('d-F-Y')
                    ->listWithLineBreaks(),

                Tables\Columns\TextColumn::make('outsoleSizeruns.started_work_time')
                    ->label('Started time')
                    ->date('h:i a')
                    ->listWithLineBreaks(),

                Tables\Columns\TextColumn::make('outsoleSizeruns.ended_work_time')
                    ->label('Ended time')
                    ->date('h:i a')
                    ->listWithLineBreaks(),
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('model_name')
                    ->options(ProductionOutsole::all()->pluck('model_name', 'model_name'))
            ])
            ->actions([
